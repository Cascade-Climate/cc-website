...
<div class="container">
	...
	<div class="areas">
		...
		<section id="erw">
			...
			<p>
				To stabilize our climate, the world must expand its capacity to affordably remove carbon dioxide from the atmosphere alongside deep emissions cuts. Enhanced rock weathering (ERW) is a carbon removal approach grounded in the centuries-old soil management practice of liming. It accelerates natural weathering processes to durably remove CO₂ while benefiting agricultural productivity.</p>
				
				<p>ERW has the potential to become an important pathway for carbon removal with agricultural benefits if key scientific and cost uncertainties are addressed.</p>

				<p>Cascade is working to clear the path forward by coordinating inter-comparable field research and developing open-science tools. We're also engaging policymakers, buyers, and standard bodies to ensure the markets and policies shaping ERW's future evolve with science.</p>
