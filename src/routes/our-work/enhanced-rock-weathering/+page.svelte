...
<svelte:head>
	<title>Enhanced Rock Weathering - Cascade Climate</title>
	<meta
		name="description"
		content="Advancing the science, tools, and policy needed to make ERW a credible, scalable pathway for carbon removal and agricultural benefit."
	/>
</svelte:head>
