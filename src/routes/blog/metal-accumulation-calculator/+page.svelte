...
<div>
	...
	<main>
		<section id="introduction">
            ...
            <p>DDue to the relatively recent rise of ERW, there are no legislative soil regulations that have been created solely with the practice of ERW in mind. Currently, there are two types of regulations that are the most relevant to ERW deployments:</p>
            <ol>
