...
<div>
	...
	<main>
		<section id="about">
            ...
            <p><span>Some knowledge on ERW and its quantification does make it easier to be oriented and feel situated in EMCE. If you are still relatively new to ERW quantification for the first time, we recommend reading the </span><a href="https://cascadeclimate.org/blog/foundations-for-carbon-removal-quantification-in-erw-deployments" target="_blank" rel="noopener"><em>Technical Summary: Foundations for Carbon Dioxide Removal Quantification in ERW Deployments </em></a><span> first.</span></p>
		</section>
