...
<div class="lrm-financing-page">
	...
	<main>
		...
		<section id="policy">
			...
			<p>
				Policy defines the endgame: a well-designed regulatory framework eventually reduces reliance on carbon finance and establishes LRM as a durable part of national cooling infrastructure. When recovery is mandated, and when Extended Producer Responsibility (EPR) schemes or technician incentive programs are funded by the value chain rather than by carbon credit buyers, LRM becomes a standard cost of doing business rather than an effort solely dependent on external subsidy. Carbon markets may continue to play a targeted role — particularly for the destruction of high-GWP legacy stocks with outsized climate value — but they are no longer load-bearing for the whole system. The Montreal Protocol’s TEAP <a href="https://ozone.unep.org/system/files/documents/TEAP-May2024-DecXXXV-11-TF-Report.pdf" target="_blank" rel="noopener noreferrer">report</a> puts it well: LRM "efforts, when combined with growing destruction capacity and deployment of financing mechanisms such as [EPR] and carbon markets, could create robust systems for ODS and HFC destruction." That transition is the goal. Getting there requires building backward from it.
			</p>
		...
		<section id="conclusion">
			...
			<p>
				If you are a stakeholder interested in accelerating the LRM transition in developing countries, particularly in Southeast Asia, we want to hear from you. Please reach out to <a href="mailto:refrigerantmanagement@cascade.org">refrigerantmanagement@cascade.org</a>.
			</p>
		</section>
	</main>
</div>
