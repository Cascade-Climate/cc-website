...
<div class="lrm-gaps-page">
	<section class="intro">
		<div class="content">
			<div class="copy">
				...
				<p>The refrigerants found in billions of cooling systems worldwide are super pollutants with warming potentials hundreds to thousands of times greater than CO<sub>2</sub>. And while the Kigali Amendment has set the world on a path to phase them down, two big gaps remain: the massive stockpile of refrigerants already in use, and the uneven road ahead in transitioning to cleaner alternatives. This post explores how lifecycle refrigerant management can close those gaps — and why it represents one of the most immediate climate wins available today.</p><br>
			</div>
	...
	<main>
		...
		<section id="addressing-the-gaps">
            ...
            <p>Lifecycle refrigerant management (LRM) —the systematic mitigation of refrigerant emissions across equipment lifecycles — addresses aspects of both gaps in the Kigali Amendment&apos;s scope. The potential for impact is substantial: LRM could mitigate 39 Gt of CO<sub>2</sub>e HFC and ODS emissions between 2025 and 2050. At roughly 1.5 Gt CO<sub>2</sub>e annually, this is comparable in scale to other high-priority superpollutant interventions such as methane capture at landfills. </p>
