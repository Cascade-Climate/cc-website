	...
	<section class="intro">
		<div class="content">
			<div class="copy">
				...
				<p>Hydrofluorocarbons — the refrigerants found in billions of cooling systems worldwide — are super pollutants with warming potentials hundreds to thousands of times greater than CO<sub>2</sub>. While the Kigali Amendment has set the world on a path to phase them down, two critical gaps remain: the massive stockpile of refrigerants already in use, and the uneven road ahead in transitioning to cleaner alternatives. This post explores how lifecycle refrigerant management can close those gaps — and why it represents one of the most immediate, cost-effective climate wins available today.</p><br>
			</div>
