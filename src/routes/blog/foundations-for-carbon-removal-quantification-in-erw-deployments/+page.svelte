...
<div>
	...
	<main>
		<section id="about">
			...
			<p>
				Nullam tincidunt tempor massa non porttitor. Aenean interdum lacus eget massa dapibus
				rutrum. Vestibulum iaculis id felis quis volutpat. Quisque malesuada auctor ullamcorper.
				Vestibulum id accumsan ligula. Duis eu quam eget leo vehicula mollis eget et est. Nulla
				facilisis dui vel erat mollis, et dictum ex aliquam. Nulla facilisi. Aliquam a sollicitudin
				neque, at luctus arcu. Suspendisse nec condimentum dolor. Suspendisse molestie bibendum
				purus eu venenatis. Fusce tincidunt dictum sodales. Sed vel cursus metus.
			</p>
		</section>
		<section id="credits">
			<h1>Credits</h1>
			...
			<PDFLink link="/example.pdf" variant="accent">Foundations for Carbon Removal Quantification in ERW Deployments - full document↗</PDFLink>
			<PDFLink link="/example.pdf" variant="accent">Foundations for Carbon Removal Quantification in ERW Deployments - technical executive summary↗</PDFLink>
		</section>
