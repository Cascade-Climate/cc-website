...
<svelte:head>
	<title>Titus Loh - Cascade Climate</title>
	<meta name="description" content="Learn more about Titus Loh's role at Cascade Climate." />
</svelte:head>
<div class="team-member">
	<div class="member-info">
		...
		<p>
			At Cascade, Titus’s focus is on exploring viable pathways for improved Lifecycle Refrigerant Management (LRM) in the cooling and refrigerant industry in Southeast Asia.
		</p>
		<p>
			Titus holds a Master’s and Bachelor’s Degree in Environmental Engineering from the University of Malaya, Malaysia, and currently resides in Singapore with his wife and two children.
		</p>
	</div>
	<div class="headshot">
		<img src={headshot} alt="Titus Loh" />
	</div>
</div>
